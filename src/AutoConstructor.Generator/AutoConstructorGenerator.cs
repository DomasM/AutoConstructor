...
public sealed class AutoConstructorGenerator : IIncrementalGenerator
{
    ...
    private static GeneratorExecutionResult? Execute(GeneratorAttributeSyntaxContext context, TypeDeclarationSyntax typeSyntax)
    {
        ...
        bool addParameterless = wantToAddParameterless && CanAddParameterlessConstructor(symbol);
    ...
    private static bool CanAddParameterlessConstructor(INamedTypeSymbol symbol)
    {
        return BaseHasAccessibleParameterlessConstructor(symbol);
    }
